...
<head>
    ...
    <title>Zynolo MeetUp - Forgot Password</title>
                                ...
                                <div class="card border">
                                    <div class="card-body p-3">
                                        ...
                                        <div class="text-center w-full m-auto">
                                            <h4 class="text-dark-50 text-center fs-2 pb-0 fw-bold">Forgot Password 😫
                                            </h4>
                                            <p class="text-muted mb-4">Forgot your password? No problem. Just let us
                                        ...
                                        <form action="#">
                                            ...
                                            <div class="mb-3">
                                                <label for="emailaddress" :value="__('Email')"
                                            ...
                                            <div class="d-grid mb-0 text-center">
                                                <button class="btn btn-primary" type="submit"><i
                                                        class="mdi mdi-login"></i> Email Password
                                                    Reset Link </button>
                                            </div>
